...
6. Projete o cadastro utilizando o padrão [Factory](https://medium.com/@nile.bits/javascript-factory-design-pattern-a-comprehensive-guide-9266b726ee5c);
...
9. Devem ser permitidas no mínimo as operações de criação, consulta e deleção dos dados de uma pessoa;
...
* Código em JavaScript, conforme proposta;
* Execução das atividades na ordem proposta;
...
* Subir o trabalho na branch com um README.md:
  ...
  * colocar o autor;
* 🔨 colocar o código fonte desenvolvido (observar estruturas de pastas);
* O prazo de entrega é até às 14h do dia 20/01/2025 no repositório do github (<https://github.com/Compass-pb-aws-2025-06-JANEIRO/sprint-1-pb-aws-janeiro>).

***
## Apresentação

* A coordenação do programa de bolsas irá agendar a apresentação, que se dará por blocos de 4 ou 5 bolsistas.
* Cada bolsista terá 5 minutos para apresentar seu readme, código e demonstração do funcionamento da aplicação.
* Após a apresentação haverão instrutores que darão o feedback técnico.
* Após todas as apresentações a coordenação fará o feedback comportamental.
